			...
			<?php
				if(Auth::hasPermission('MODULES::INSTALL') && $tab == 'install') {
                    ...
                    <div class="nav nav-tabs">
                        <li class="nav-item modules-popular"><a class="nav-link active"
                                                                id="popular-tab" role="tab" data-bs-toggle="tab"
                                                                data-bs-target="#popular"
                                                                role="tab"><?php I18N::__('Popular'); ?></a>
                        </li>
                        <li class="nav-item modules-results"><a class="nav-link disabled" aria-disabled="true"
                                                                role="tab"
                                                                id="results-tab" role="tab" data-bs-toggle="tab"
                                                                data-bs-target="#results"
                                                                aria-disabled="true"><?php I18N::__('Results'); ?></a>
                        </li>
