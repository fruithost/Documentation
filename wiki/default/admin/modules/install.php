...
<div id="module-results" data-fetching="true">
    ...
    <div class="loaded-content tab-content">
        <div class="container mt-5 mb-5 tab-pane show active" id="popular" role="tabpanel"
             aria-labelledby="popular-tab">
            <div class="row row-cols-1 row-cols-md-3 g-4 modules-list"></div>
        </div>
        <div class="container mt-5 mb-5 tab-pane" id="results" role="tabpanel"
